...
export const CATALOG = [
    ...
    { id: 'scarf', name: 'Cachecol Fofo', price: 1000, currency: 'coins', icon: 'scarf', iconLib: 'FontAwesome5', tab: 'accessory', category: 'Superior', rarity: 'rare' as ItemRarity, description: 'Protege seu pet nos dias mais frios.' },
